...
export class CanvasManager {
  ...
  public clearCanvases(): void {
    this.backgroundCTX.clearRect(0,0, GSM.GridManager.map.size.x * GSM.Settings.blockSize, GSM.GridManager.map.size.y * GSM.Settings.blockSize)
    this.backgroundCTX.imageSmoothingEnabled = false
    this.foregroundCTX.clearRect(0,0, GSM.GridManager.map.size.x * GSM.Settings.blockSize, GSM.GridManager.map.size.y * GSM.Settings.blockSize)
    this.foregroundCTX.imageSmoothingEnabled = false   
    this.fullImageCTX.clearRect(0,0, GSM.GridManager.map.size.x * GSM.Settings.blockSize, GSM.GridManager.map.size.y * GSM.Settings.blockSize)
